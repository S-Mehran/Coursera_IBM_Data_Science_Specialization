...
app.layout = html.Div(children=[html.H1("Australia's Wildfire Dashboard"),
     ...
     html.Div([
                   # First inner divsion for  adding dropdown helper text for Selected Drive wheels
                    ...
                    dcc.RadioItems([{"label":"New South Wales","value": "NSW"},
                                    ...
                                    {"label":"Tasmania","value": "TA"}], value = "NSW", id='region',inline=True)]),
                    #Dropdown to select year
                    html.Div([
                            html.H2('Select the Year', style={'margin-right': '2em'}),
                        dcc.Dropdown(
                            df.Year.unique(),
                            id='year',
                            value=2010,
...
def reg_year_display(input_region,input_year):
   ...
   veg_data = y_r_data.groupby('Month')['Count'].sum().reset_index()

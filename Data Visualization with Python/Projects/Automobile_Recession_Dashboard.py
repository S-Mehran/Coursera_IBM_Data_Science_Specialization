...
app.layout = html.Div([
    ...
    html.H1("Automobile Sales Statistics Dashboard", style={'color': '#503D36', 'font-size': 30, 'textAlign':'center'}),#Include style for title
    ...
    html.Div([
        ...
        dcc.Dropdown(
            ...
            style={'padding':'3px', 'font-size': '20px','text-align':'center'}
        )
    ]),
...
# Plot 3 Pie chart for total expenditure share by vehicle type during recessions
	...
	# Hint:Use Vehicle_Type and Advertising_Expenditure columns
        ...
        R_chart3 = dcc.Graph(figure=px.pie(exp_rec, values='Advertising_Expenditure', names='Vehicle_Type', title='Total Expendiiture Sale by Vehicle Type during Recessions'))
...
# Plot 2 Total Monthly Automobile sales using line chart.
  ...
  # Plot bar chart for average number of vehicles sold during the given year
        ...
        Y_chart3 = dcc.Graph(figure=px.bar(avr_vdata, x='Automobile_Sales', y='Vehicle_Type',title='Average Vehicles Sold by Vehicle Type in the year {}'.format(input_year)))
